...
> 2026-09-18：取消备份后的 P1–P4 最小本地持久化已经完成。无模型合成样本通过正常启停、专属容器重建和一次 Windows 整机重启读回，本机非回环端口负向与组合回归也已通过。另一设备负向仍归原 M1 任务 14，限制五人远程开放，但不阻塞本地目标完成。最新证据由[实施行动](../../../actions/2026-09-17-minimal-local-persistence.md)维护。
